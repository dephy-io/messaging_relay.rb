  ...
  module Backends
    module UuidCursor
      ...
      def pagy_uuid_cursor(collection, vars = {})
        ...
        limit = pagy_uuid_cursor_get_limit(collection, pagy, pagy.position)
        pagy.has_more = pagy_uuid_cursor_has_more?(limit, pagy)
      ...
      def pagy_uuid_cursor_get_limit(collection, pagy, position = nil)
        if position.present?
      ...
      def pagy_uuid_cursor_has_more?(collection, pagy)
        ...
        pagy_uuid_cursor_get_limit(collection, pagy, next_position).exists?
      end
    end
  end
end
